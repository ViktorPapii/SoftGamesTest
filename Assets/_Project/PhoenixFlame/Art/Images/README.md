...
| `ember_dot.png`, `flame_glow.png`, `backdrop.png` | Generated by **Tools ▸ SoftGames ▸ Phoenix Flame ▸ Rebuild Textures And Materials**. |
...
The generated three are white with the shape in the alpha channel, so one texture serves every
colour in the cycle.
