...
namespace SoftGames.MagicWords.EditorTools
{
    ...
    {
        private const string AtlasPath = "Assets/_Project/MagicWords/Art/Emoji/EmojiAtlas.png";
        private const string SpriteAssetPath = "Assets/_Project/MagicWords/Art/Emoji/EmojiAtlas.asset";
        private const int CellSize = 64;
        private const int Columns = 3;

        // Grid order, left to right and top to bottom. Mirrors Assets/_Project/MagicWords/Art/Emoji/README.md.
